...
# Final Data
source(paste(getwd(), "scripts/Data_Final.R", sep = "/"))
```
...
To aide BallMapper, we transformed our data to either a rate or a percentage change from the previous year where appropriate. This ensures all dimensions of our data stay on a 0-100 scale and helps with the time complexity of BallMapper.
...
# Analysis Data
source(paste(getwd(), "scripts/BallMapper_Analysis.R", sep = "/"))
