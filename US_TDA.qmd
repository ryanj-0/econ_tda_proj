...
Since out graph consists of 40 nodes and three components we will provide all the singletons in a table (@fig-Singlton_Summary), and talk more in depth about our components below.
