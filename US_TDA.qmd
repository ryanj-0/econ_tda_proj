...
subtitle: FA24 Honors Macroeconomics Project - Revised Sept 2025
author: 
  -  Ryan Johnson
date: October 2025
...
```{r}
#| label: Load Packages and API Key
#| include: false
...
```{r}
#| label: Import BEA: GDP
#| warning: false

source(paste(getwd(), "scripts/importBEA_GDP.R", sep = "/"))
